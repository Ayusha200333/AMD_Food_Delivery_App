    ...
    <SafeAreaView className="flex-1 bg-gradient-to-b from-green-50 to-white">
      ...
      >
        <Animatable.View
          animation="zoomIn"
          duration={1000}
            style={{ alignItems: "center", paddingTop: 80, paddingBottom: 40 }}
    ...
    <Text className="text-xl text-gray-700 mt-4 text-center">
      Thank you for your order!
        ...
        <View className="px-9 space-y-4">
          <TouchableOpacity 
            className="bg-indigo-600 py-5 rounded-2xl items-center shadow-lg mb-4"
            onPress={() => router.replace("/orders")}
          >
            <Text className="text-white text-xl font-bold">View My Orders</Text>
          </TouchableOpacity>

          <TouchableOpacity
            className="bg-green-600 py-5 rounded-2xl items-center shadow-lg"
            onPress={() => router.replace("/foods")}
          >
            <Text className="text-white text-xl font-bold">Order More Food</Text>
          </TouchableOpacity>
